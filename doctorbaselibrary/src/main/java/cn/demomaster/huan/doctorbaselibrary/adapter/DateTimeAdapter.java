...
public class DateTimeAdapter extends RecyclerView.Adapter<DateTimeAdapter.ViewHolder> {
    ...
    public DateTimeAdapter(Context context, List<CalendarTimeItemModel> lists) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onItemClickListener != null) {
                    onItemClickListener.onClick(v,position ,lists.get(position).getDate());
                }
            }
        });
    }
    ...
    public static interface OnItemClickListener {
        void onClick(View v, int position,String dateStr);
    }
