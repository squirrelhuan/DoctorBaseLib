 ...
 */
package cn.demomaster.huan.doctorbaselibrary.ocr;
...
public class BaiduOcrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_baidu_ocr);
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BaiduOcrActivity.this, IDCardActivity.class);
