...
public class AreaPickerPopWin extends PopupWindow implements View.OnClickListener {
        ...
        if (v != this.contentView && v != this.cancelBtn) {
            if (v == this.confirmBtn) {
                if (null != this.mListener) {
                    ...
                    sb.append(String.valueOf(this.provinceList.get(this.provincePos)));
                    sb.append(" ");
                    sb.append(String.valueOf(this.cityList.get(this.cityPos)));
    ...
    private List<AreaModel> getArea(int type) {
        if (type == 0) {
            ...
            String str = FileUtil.getFromAssets(mContext, "area_shanghai.conf");
