...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initView() {
        this.contentView = LayoutInflater.from(this.mContext).inflate(this.showDayMonthYear ? cn.demomaster.huan.quickdeveloplibrary.R.layout.layout_date_picker_inverted : cn.demomaster.huan.quickdeveloplibrary.R.layout.layout_date_picker, (ViewGroup)null);
       this.contentView.setLayoutParams(mWindowParams);
        this.cancelBtn = (Button)this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.btn_cancel);
        this.cancelBtn.setTextColor(this.colorCancel);
        this.cancelBtn.setTextSize((float)this.btnTextsize);
        this.confirmBtn = (Button)this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.btn_confirm);
        this.confirmBtn.setTextColor(this.colorConfirm);
        this.confirmBtn.setTextSize((float)this.btnTextsize);
        this.tv_sign_year = this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.tv_sign_year);
        this.tv_sign_year.setTextColor(this.colorSignText);

        this.tv_sign_month = this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.tv_sign_month);
        this.tv_sign_month.setTextColor(this.colorSignText);

        this.tv_sign_day = this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.tv_sign_day);
        this.tv_sign_day.setTextColor(this.colorSignText);

        this.yearLoopView = (LoopView)this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.picker_year);
        this.monthLoopView = (LoopView)this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.picker_month);
        this.dayLoopView = (LoopView)this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.picker_day);
        this.pickerContainerV = this.contentView.findViewById(cn.demomaster.huan.quickdeveloplibrary.R.id.container_picker);
