...
import static cn.demomaster.huan.doctorbaselibrary.util.DateTimeUtil.getWeekName;
...
//更新分钟
    ...
    private void initPickerViews() {
        ...
        if (dateTime_ydm != null) {
            this.monthDayPos = getDefIndex(format2MonthDayStr(dateTime_ydm) + "  " + getWeekName(dateTime_ydm), monthDayList);
        }
        //时
        int startHour = 8;
    ...
    public void onClick(View v) {
        if (null != this.mListener) {
            ...
            sb.append(String.valueOf(this.dateTimeModels.get(this.monthDayPos).getDate()));
            sb.append(" ");
            sb.append(String.valueOf(this.hourList.get(this.hourPos)));
            sb.append(":");
            sb.append(String.valueOf(this.minuteList.get(this.minutePos)));
            sb.append(":00");
    ...
    private List<DateTimeModel> getDateTime() {
        ...
        for (String s : dateList) {
            ...
            dateTimeModel.setWeek(getWeekName(s));
